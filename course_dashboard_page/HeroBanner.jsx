  ...
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] h-[26rem] p-12 text-white">
      ...
      <div className="relative z-10 max-w-2xl">
        <span className="inline-block px-4 py-2 bg-primary backdrop-blur-md text-xs font-semibold uppercase tracking-wider mb-6">
          Learning Dashboard
        </span>
        ...
        <div className="flex gap-4">
          <button className="bg-blue-600 hover:bg-blue-700 px-8 py-3.5 rounded-lg font-semibold flex items-center gap-2 transition-all hover:shadow-blue-500/30">
            Continue learning <MoveRight size={18} />
          </button>
          <button className="bg-white/10 hover:bg-white/20 backdrop-blur-sm px-10 py-4.5 rounded-lg font-semibold border border-white/20 transition-all">
            View Progress
          </button>
        </div>
      </div>
