...
const testimonials = [
  ...
  {
    id: 2,
    text: 'LearnX completely changed how I learn. The courses are well-structured and the tutors are absolutely incredible.',
    name: 'Sarah Williams',
    role: 'UI Designer, LearnX',
