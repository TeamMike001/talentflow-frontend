  ...
  return (
    <main className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col items-center justify-center px-16 text-white text-center">
        ...
        <p className="text-lg leading-relaxed mb-1 text-white/90">Welcome Back.</p>
        <p className="text-lg leading-relaxed text-white/90">
          You are just one step away to your feed.
        </p>

        <div className="mt-16">
          <p className="text-white/80 text-base mb-5">Don&apos;t have an account?</p>
          <Link
            href="/signup"
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-400 text-sm mb-8">Sign into your Dashboard</p>
