...
import { Send, Search, Users, Paperclip, Image, X, Check, Clock, MessageCircle, User, Mail, Circle, RefreshCw } from 'lucide-react';
...
export default function InstructorMessages() {
  ...
  const updateLastMessageTime = (userId, timestamp) => {
    ...
    client.onConnect = () => {
      ...
      client.subscribe('/user/queue/private', (message) => {
        try {
          ...
          updateLastMessageTime(senderId, timestamp);
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (formattedMessages.length > 0) {
          ...
          updateLastMessageTime(userId, lastMsg.timestamp);
        }
      }
    } catch (error) {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const now = Date.now();
      updateLastMessageTime(selectedUser.id, now);
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                  {messages.length === 0 ? (
                    <div className="text-center py-20 text-gray-500">
                      ...
                      <p>No messages yet. Start a conversation with {selectedUser.name || 'this user'}!</p>
                    </div>
                  ) : (
                    messages.map((msg) => (
                ...
                <div className="p-4 bg-white border-t">
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      placeholder={connected ? `Message ${selectedUser.name || 'user'}...` : "Connecting..."}
