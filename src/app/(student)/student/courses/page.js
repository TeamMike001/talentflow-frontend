    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 lg:ml-56 flex flex-col">
        ...
        <main className="flex-1 p-6 space-y-10">
          ...
          {/* 1. HERO BANNER */}
<section className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-blue-900 via-purple-900 to-orange-600 p-8 min-h-[220px] flex flex-col justify-center">
  <div className="absolute right-0 top-0 w-64 h-64 bg-white/5 rounded-full -mr-20 -mt-20 blur-3xl" />
  <div className="relative z-10 max-w-lg">
    <span className="inline-block bg-white/20 backdrop-blur-md text-white text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-4">
      Learning Dashboard
    </span>
    <h1 className="text-3xl font-extrabold text-white mb-2">Welcome back, Titus!</h1>
    <p className="text-white/80 text-sm mb-6">
      You&apos;ve completed 75% of your weekly goal. Your next lesson is waiting.
    </p>
            ...
            <Link
                ...
                className="bg-white text-blue-900 font-bold text-xs px-5 py-2.5 rounded-xl hover:bg-gray-100 transition-all flex items-center justify-center"
            >
                Continue Learning →
            </Link>
            <Link
                href="/student/StudentCourses"
                className="bg-white/10 border border-white/20 text-white font-bold text-xs px-5 py-2.5 rounded-xl hover:bg-white/20 transition-all flex items-center justify-center"
            >
                View Progress
            </Link>
            </div>
          ...
          {/* 2. FEATURED SLIDER SECTION */}
          <section>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="font-extrabold text-gray-900 text-base">Master New Skills That Matter</h2>
                <p className="text-gray-400 text-[10px]">Expert-led paths designed to turn your ambition into a career.</p>
              </div>
          ...
          {/* 4. MAIN COURSE EXPLORER (FILTERS + GRID) */}
            ...
            <div className="flex gap-8 items-start">
              ...
              <aside className="w-52 flex-shrink-0 bg-white rounded-2xl border border-gray-100 p-5 sticky top-6">
                  ...
                  <div className="space-y-2.5">
                    {categories.map((cat) => (
                      <label key={cat} className="flex items-center gap-2.5 cursor-pointer group">
                        <input type="checkbox" checked={selectedCategories.includes(cat)} className="w-3.5 h-3.5 accent-blue-600 rounded" readOnly/>
                ...
                <FilterSection title="Level">
                  <select className="w-full border border-gray-100 rounded-lg px-2 py-1.5 text-[10px] bg-gray-50 outline-none">
                ...
                <button className="w-full py-2.5 mt-4 bg-blue-600 text-white text-[10px] font-bold rounded-xl shadow-lg shadow-blue-200">Apply Filters</button>
                <button className="w-full py-2 text-[10px] text-gray-400 mt-1">Clear All</button>
              </aside>
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <button className="flex items-center gap-2 text-[10px] text-gray-500 border border-gray-200 px-3 py-1.5 rounded-lg bg-white">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {/* Reusing common CourseCard component */}
