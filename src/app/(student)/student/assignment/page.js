      ...
      <div className="flex-1 lg:ml-56 flex flex-col">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-extrabold text-gray-900">Wireframe Task</h1>
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div
                  ...
                  className="border-2 border-dashed border-gray-200 rounded-xl p-10 text-center cursor-pointer hover:border-primary hover:bg-blue-50/20 transition-all mb-5"
                >
                ...
                <div className="flex items-center justify-between">
                  <button className="px-6 py-2.5 border border-gray-300 text-gray-600 text-sm font-semibold rounded-lg hover:bg-gray-50 transition-colors">
                    Save Draft
                  </button>
                  <button
                    onClick={handleSubmit}
                    className="px-8 py-2.5 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary-dark transition-all shadow-md"
                  >
                    Submit Assignment
                  </button>
                </div>
